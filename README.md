...
* Ainda no arquivo `app.py`, verifique o final do código no bloco `if __name__ == '__main__':` e insira/atualize o seu token do ngrok na função `ngrok.set_auth_token("SEU_TOKEN_AQUI")`.
